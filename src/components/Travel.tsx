...
const TIPS = [
  ...
  { icon: '🚗', title: { en: 'Getting to Eldoret', de: 'Nach Eldoret kommen' }, body: { en: 'From Nairobi (JKIA): Fly to Eldoret Airport (EDL) — 45 min. Or shuttle/matatu (~4h). The wedding team can help arrange group transport.', de: 'Von Nairobi: Flug nach Eldoret (EDL) — 45 Min. Oder Shuttle (~4h). Das Hochzeitsteam hilft bei der Gruppenreise.' } },
